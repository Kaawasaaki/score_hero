...
if user_input.lower() == "s":
    ...
    stats_pace = random.randrange(40,99)
    stats_dribbling = random.randrange(1,99)
    stats_shooting = random.randrange(40,99)
    stats_passing = random.randrange(40,99)
    stats_defending = random.randrange(40,99)
    stats_diving = random.randrange(40,99)
    ...
    stats_pace == int(stats_pace)
    stats_defending == int(stats_defending)
    stats_dribbling == int(stats_dribbling) 
    stats_shooting == int(stats_shooting)
    stats_passing == int(stats_passing)
    stats_diving == int(stats_diving)
    
    overall = int(stats_diving + stats_defending + stats_pace + stats_dribbling + stats_passing+ stats_shooting)
    
    score_overall = overall % 100
